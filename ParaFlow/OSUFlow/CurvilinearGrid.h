...
//	int	locate(VECTOR3&, VECTOR3&, VECTOR3*) const;
	...
	int	walk_on_x_boundary(VECTOR3 pp, int plane_pos,double& min_d2,VECTOR3& min_v);
	int	walk_on_y_boundary(VECTOR3 pp, int plane_pos,double& min_d2,VECTOR3& min_v);
	int	walk_on_z_boundary(VECTOR3 pp, int plane_pos,double& min_d2,VECTOR3& min_v);

...
// Maximum number of edges/vertices per MPASO cell.
// Must match MAX_EDGES used in phys_to_cell (Grid.C).
constexpr int MPASO_MAX_EDGES = 10;
...
typedef struct PointInfo
{
	...
	double MPASO_interpolant[MPASO_MAX_EDGES + 1]; // [0..nVert-1]: horizontal weights, [nVert]: vertical weight
	int nVertices;
